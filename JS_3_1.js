...
// зарегистрированных 09.10.2021 и 10.10.2021). Массив в task1.t
...
function view_registration_09_10(u)
{
    u.forEach(el => {
        if (el.registrationDate == "09.10.2021" || el.registrationDate == "10.10.2021") console.log(el);
    });
}

view_registration_09_10(users)